          ...
          if (safeGet(data)) {
            ...
            if(data.retCode ===0){
              if(data.data.signStatus===0){
                console.log(`签到成功，获???${data.data.pingoujin}金币，已签到${data.data.signDays}天`)
                $.coins += parseInt(data.data.pingoujin)
              }else{
                console.log(`今日已签到`)
              }
            }else{
              console.log(`签到失败，错误信???${data.errMsg}`)
            }
          }
        }
      } catch (e) {
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if(data.retCode ===0){
              ...
              console.log(`任务完成失败，错误信???${data.errMsg}`)
            }
          }
        }
      } catch (e) {
      ...
      try {
        if (err) {
          ...
          if (safeGet(data)) {
            data = JSON.parse(data);
            if(data.retCode ===0){
              console.log(`任务完成成功，获得金???${data.datas[0]['pingouJin']}`)
      ...
      try {
        if (err) {
          ...
          if (safeGet(data)) {
            data = JSON.parse(data);
            if(data.retCode ===0){
              console.log(`双签成功，获得金???${data.data.jd_amount / 100}元`)
