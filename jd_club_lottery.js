...
[task_local]
#摇京???
5 0 * * * https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_club_lottery.js, tag=摇京???, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdyjd.png, enabled=true
=================Loon===============
[Script]
cron "5 0 * * *" script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_club_lottery.js,tag=摇京???
=================Surge==============
[Script]
摇京??? = type=cron,cronexp="5 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_club_lottery.js

============小火???=========
摇京??? = type=cron,script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_club_lottery.js, cronexpr="5 0 * * *", timeout=3600, enable=true
*/
      ...
      try {
        if (err) {
          ...
          if (data.success) {
            ...
            console.log(`新版——摇奖次???${$.leftShakingTimes}`);
          }
        }
      } catch (e) {
        $.logErr(e, resp);
