...
let ACTIONS_TRIGGER_TOKEN = '';//Personal access tokens，申请教???:https://www.jianshu.com/p/bb82b3ad1d11 记得勾选repo权限就行
let TRIGGER_KEYWORDS = '';//.github/workflows/路径里面yml文件里面repository_dispatch项目的types值，例如jd_fruit.yml里面的值为fruit
let githubUser = '';//github用户名，???:LXK9301
let repo = '';//需要触发的 Github Action 所在的仓库名称 ???:scripts
