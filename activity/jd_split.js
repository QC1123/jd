...
[task_local]
#金榜年终奖
10 0 * * * https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_split.js, tag=年终???, enabled=true

================Loon==============
[Script]
cron "10 0 * * *" script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_split.js,tag=年终???

===============Surge=================
金榜年终??? = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_split.js

============小火???=========
金榜年终??? = type=cron,script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_split.js, cronexpr="10 0 * * *", timeout=3600, enable=true
 */
const $ = new Env('金榜年终???');
