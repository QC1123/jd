...
[task_local]
#京东宠汪汪喂食
15 0-23/1 * * * https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_joy_feedPets.js, tag=京东宠汪汪喂???, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true

==============Loon===============
[Script]
cron "15 0-23/1 * * *" script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_joy_feedPets.js,tag=京东宠汪汪喂???

=========Surge=============
[Script]
京东宠汪汪喂??? = type=cron,cronexp="15 0-23/1 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_joy_feedPets.js

===============小火???==========
京东宠汪汪喂??? = type=cron,script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_joy_feedPets.js, cronexpr="15 0-23/1 * * *", timeout=3600, enable=true
*/
...
let FEED_NUM = ($.getdata('joyFeedCount') * 1) || 10;   //喂食数量默认10g,可??? 10,20,40,80 , 其他数字不可.
...
function showMsg() {
  ...
  if (!jdNotify || jdNotify === 'false') {
    $.msg($.name, subTitle, `【京东账???${$.index}???${$.UserName}\n` + message);
  }
}
