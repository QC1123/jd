...
[task_local]
#注销京东会员卡
55 23 * * * https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_unbind.js, tag=注销京东会员???, img-url= https://raw.githubusercontent.com/58xinian/icon/master/jd_unbind.png, enabled=true
=======Loon========
[Script]
cron "55 23 * * *" script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_unbind.js,tag=注销京东会员???
========Surge==========
注销京东会员??? = type=cron,cronexp="55 23 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_unbind.js
=======小火???=====
注销京东会员??? = type=cron,script-path=https://raw.githubusercontent.com/LXK9301/jd_scripts/master/jd_unbind.js, cronexpr="10 23 * * *", timeout=3600, enable=true
 */
const $ = new Env('注销京东会员???');
...
async function unsubscribeCards() {
  ...
  for (let item of $.cardList) {
    if (count === cardPageSize * 1){
      console.log(`已达到设定数???:${cardPageSize * 1}`)
      break
    }
